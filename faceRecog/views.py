...
def detect(request):
    ...
    while(True):
        ...
        for(x,y,w,h) in faces:
            ...
            if userId == 1:
                cv2.putText(img, "Masum",(x,y+h), font, 2, (0,255,0),2)
                # Put text describe who is in the picture
            elif userId == 2:
                cv2.putText(img, "Shihab",(x,y+h), font, 2, (0,255,0),2)
                # Put text describe who is in the picture
            elif userId == 3:
                cv2.putText(img, "Abrar",(x,y+h), font, 2, (0,255,0),2)
            elif userId == 5:
                cv2.putText(img, "Mahabub",(x,y+h), font, 2, (0,255,0),2)
            else:
            ...
            #else:
                #cv2.putText(img, "Masum",(x,y+h), font, 2, (0,0,255),2)
...
def eigenTrain(request):
    ...
    target_names = ['Masum Junayed', 'Shihab Bro', 'Abrar Bro']
    n_components = 15
